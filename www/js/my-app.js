...
$$("#normalBtn").on('click', function () {
    location.href = "8_Normal.html";
});

$$("#BabiesList").on('click', function(){
    location.href = "BabiesList.html";
});

$$("#Baby1").on('click', function () {
    location.href = "Baby1.html";
});

$$("#BPhase1").on('click', function () {
    location.href = "BPhase1.html";
});

$$("#BPhase2").on('click', function () {
    location.href = "BPhase2.html";
});

$$("#DangerSign").on('click', function() {
    location.href = "DangerSign.html";
});

$$("#Normalcondition").on('click', function () {
    location.href = "Normalcondition.html";
});

$$("#ProblemAbnTemp").on('click', function () {
    location.href = "ProblemAbnTemp.html";
});

$$("#ProblemPoorFeeding").on('click', function(){
    location.href = "ProblemPoorFeeding.html";
});

$$("#ProblemUnderWt").on('click', function () {
    location.href = "ProblemUnderWt.html";
});
